...
> **Objetivo: você nunca vê o monstro inteiro.** Cada tarefa é uma fatia vertical fina (poucas horas a 1 dia), entrega **algo visível/testável no ar**, e o schema do banco **cresce tabela-a-tabela** conforme a feature precisa — você NÃO constrói as 14 tabelas de uma vez.
...
- **Após TASK-005:** você loga num painel de verdade, no ar. (fim da fundação)
